...
export default function Food() {
  ...
  const products = [
    {
      image: "/pizza-cheese.jpg", // Replace with actual image path
      description: "Meaty",
      price: "M65.00",
    },
    {
      image: "/pizza-home.jpg", // Replace with actual image path
      description: "Cheese ",
      price: "M60.00",
    },
    {
      image: "/pizza.jpg", // Replace with actual image path
  ...
  return (
    <div className="mt-10 px-64">
      <h2 className="text-center text-1xl  mb-6">Nucleus Pizza</h2>
      <Carousel>
