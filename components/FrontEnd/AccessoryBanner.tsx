...
export default function Carousel() {
  ...
  const slides: Slide[] = [
    { id: 0, src: "/accessory.jpg"},
    { id: 1, src: "/accessoryb.jpg"},
    { id: 2, src: "/accessoryc.jpg"},
  ...
  return (
    <div id="default-carousel" className="container  mt-15 px-64" data-carousel="slide" >
      <div className="relative justify-center h-96 overflow-hidden rounded-lg md:h-56 mt-15">
