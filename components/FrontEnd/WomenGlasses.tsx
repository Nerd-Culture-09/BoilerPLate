...
export default function CarouselSpacing() {
  ...
  const products = [
    {
      image: "/earc.jpg", // Replace with actual image path
      description: "Rain boots for kids",
      price: "M190.00",
    },
    {
      image: "/ear.jpg", // Replace with actual image path
      description: "Beautiful girls shoes",
      price: "M120.00",
    },
    {
      image: "/eard.jpg", // Replace with actual image path
      description: "G-Wagon Powered Car for Kids",
      price: "M300.00",
    },
    {
      image: "/neckb.jpg", // Replace with actual image path
      description: "Rain Coat for Kids",
      price: "M200.00",
    },
    {
      image: "/neckc.jpg", // Replace with actual image path
  ...
  return (
    <div className="mt-10 px-64">
      <h2 className="text-center text-1xl  mb-6">Accessories</h2>
      <Carousel>
