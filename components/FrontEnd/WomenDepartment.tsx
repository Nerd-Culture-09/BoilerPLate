...
export default function WomenDepartment() {
  ...
  const products = [
    {
      image: "/dress.jpg", // Replace with actual image path
      description: "Rain boots for kids",
      price: "M190.00",
    },
    {
      image: "/dressb.jpg", // Replace with actual image path
      description: "Beautiful girls shoes",
      price: "M120.00",
    },
    {
      image: "/dressc.jpg", // Replace with actual image path
      description: "G-Wagon Powered Car for Kids",
      price: "M300.00",
    },
    {
      image: "/dresse.jpg", // Replace with actual image path
  ...
  return (
    <div className="mt-10 px-64">
      <h2 className="text-center text-1xl  mb-6">Dresses</h2>
      <Carousel>
