...
export default function CarouselSpacing() {
  ...
  const products = [
    {
      image: "/bag.jpg", // Replace with actual image path
      description: "Rain boots for kids",
      price: "M190.00",
    },
    {
      image: "/bagb.jpg", // Replace with actual image path
      description: "Beautiful girls shoes",
      price: "M120.00",
    },
    {
      image: "/bagc.jpg", // Replace with actual image path
      description: "G-Wagon Powered Car for Kids",
      price: "M300.00",
    },
    {
      image: "/bagd.jpeg", // Replace with actual image path
  ...
  return (
    <div className="mt-10 px-64">
      <h2 className="text-center text-1xl  mb-6">Hand Bags</h2>
      <Carousel>
